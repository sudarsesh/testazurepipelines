#!/usr/bin/env python3
"""
Ref: https://github.com/Azure/azure-powershell/issues/17460
Ref: https://github.com/Azure/azure-rest-api-specs/blob/main/specification/automation/resource-manager/Microsoft.Automation/stable/2018-06-30/python2package.json
Ref: https://github.com/azureautomation/runbooks/blob/master/Utility/Python/import_py3package_from_pypi.py
...
def make_temp_dir():
    destdir = os.path.abspath("tempDownloadDir")
